...
// const apiUrl = "http://192.168.2.243/VAULT/api/";
// const apiUrl = "http://138.3.210.160//VAULT/api/";

const apiUrl = "http://vault.technobest.online/api/";
// const apiUrl = "http://138.3.210.160:81/api/";
...
// const apiUrl = "http://188.180.100.35/Tracking-API/api/";
//const apiUrl = "http://188.180.99.25/api/";
//const apiUrl = "http://192.168.1.109/api/";
// const rootURL = "http://188.180.99.25:81/";
// const apiUrl = "http://188.180.99.25:81/api/";

// const rootURL = "http://188.180.66.231/";
// const apiUrl = "http://188.180.66.231/Tracking-API/api/";

// const rootURL = "http://222.127.51.145/";
// const apiUrl = "http://222.127.51.145/Tracking-API/api/";

// const rootURL = "https://localhost:44373/";
// const apiUrl = "https://localhost:44373/api/";

// const rootURL = "http://125.5.216.98/";
// const apiUrl = "http://125.5.216.98/Tracking-API/api/";

// const rootURL = "http://188.180.100.35/";
// const apiUrl = "http://188.180.100.35/Tracking-API/api/";

// final state = js.JsObject.fromBrowserObject(js.context['host']);
// var rootURL = state['build_type'] == 'live'
//     ? state['live_server_root']
//     : state['build_type'] == 'local'
//         ? state['local_server_root']
//         : state['debug_server_root'];
// var apiUrl = state['build_type'] == 'live'
//     ? state['live_server_api']
//     : state['build_type'] == 'local'
//         ? state['local_server_api']
//         : state['debug_server_api'];

final formatter = NumberFormat('###,###,###,##0.00');
final amountFormatter = NumberFormat('###,###,###,##0.00');
final percentFormatter = NumberFormat('#0.00');
final dateFormatter = DateFormat('MMM dd, yyyy hh:mm:ss aa');
final dateOnlyFormatter = DateFormat('MMMM dd, yyyy');
final dayOnlyFormatter = DateFormat('dd');
final monthOnlyFormatter = DateFormat('MMM');
final randomNumber = Random();
const defaultRadius = Radius.circular(8);
const double defaultBorderRadius = 8;
const cardElevation = 10.5;
